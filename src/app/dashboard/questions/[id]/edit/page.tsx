...
export default function EditQuestionPage() {
  ...
  const [question, setQuestion] = useState<QuestionWithTopic | null>(null)
  ...
  const fetchQuestion = useCallback(async () => {
    try {
      ...
      if (response.ok) {
        ...
        setQuestion(data)
        setFormData({
          classId: data.topic.subject.class.id,
          subjectId: data.topic.subject.id,
      ...
      <div className="bg-white shadow rounded-lg p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-600">Modify the question details</p>
          </div>
          <a
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Correct Answer, Difficulty, and Status */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
                Correct Answer *
          ...
          <div className="flex justify-end space-x-3 pt-6 border-t">
            ...
            >
              {isSubmitting ? "Updating Question..." : "Update Question"}
            </button>
          </div>
        </form>
      </div>
